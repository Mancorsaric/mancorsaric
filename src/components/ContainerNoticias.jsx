...
export const ContainerNoticias = ({noticias, loading}) => {
  ...
  if(noticias === null || loading){
    return (
      ...
      style={{backgroundColor: 'var(--yellow-light)', width: '97%', height: '90%', marginLeft: '1rem', borderRadius: ' 10px'}}>
        <Spinner className="mb-2" style={{ height: '5rem', width: '5rem', fontSize: '2rem', color: 'var(--palette-green-dark)' }}/>
  ...
  if(noticias.length === 0){
    return (
      <div className="contenedor-noticias d-flex flex-column align-items-center justify-content-center" 
      style={{backgroundColor: 'var(--palette-yellow-light)', width: '97%', height: '70%', marginLeft: '1rem', borderRadius: ' 10px'}}>
